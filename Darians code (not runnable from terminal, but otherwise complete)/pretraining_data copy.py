...
file_path = '/Users/darianlee/PycharmProjects/entity_preprocessing/train-v1.1.json'
...
french = pd.read_csv("/Users/darianlee/PycharmProjects/entity_preprocessing/df_fr.csv")
italian = pd.read_csv("/Users/darianlee/PycharmProjects/entity_preprocessing/df_it.csv")
spanish = pd.read_csv("/Users/darianlee/PycharmProjects/entity_preprocessing/df_es.csv")
...
csv_dir = '/Users/darianlee/PycharmProjects/entity_preprocessing/csv_files/'

# Ensure the directory exists
os.makedirs(csv_dir, exist_ok=True)

# Iterate over the tokenizers dictionary and save each language's data as a CSV
...
df.to_csv('/Users/darianlee/PycharmProjects/entity_preprocessing/blocks.csv', index=False)
