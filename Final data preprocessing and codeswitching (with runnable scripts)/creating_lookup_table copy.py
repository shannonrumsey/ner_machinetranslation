...
def main():
    ...
    parser = argparse.ArgumentParser(description="Load JSONL files for Spanish, Italian, and French data.")
    parser.add_argument('--data_es', type=str, required=True, help="Path to the Spanish data file (es.jsonl)")
    parser.add_argument('--data_it', type=str, required=True, help="Path to the Italian data file (it.jsonl)")
    parser.add_argument('--data_fr', type=str, required=True, help="Path to the French data file (fr.jsonl)")
    parser.add_argument('--output_es', type=str, required=True, help="Path to save the Spanish lookup table (es.json)")
    parser.add_argument('--output_it', type=str, required=True, help="Path to save the Italian lookup table (it.json)")
    parser.add_argument('--output_fr', type=str, required=True, help="Path to save the French lookup table (fr.json)")
    ...
    import json
    with open(args.output_es, 'w', encoding='utf-8') as f:
    ...
    with open(args.output_it, 'w', encoding='utf-8') as f:
    ...
    with open(args.output_fr, 'w', encoding='utf-8') as f:
