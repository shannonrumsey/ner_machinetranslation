...
def main():
    ...
    parser = argparse.ArgumentParser(description="Load CSV files and other data paths")

    # Add arguments for paths
    parser.add_argument("folder_path", type=str, help="Path to the folder containing CSV files")
    parser.add_argument("pretrain_path", type=str, help="Path to the pretrain CSV file")
